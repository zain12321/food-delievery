  ...
  return (
    <div className='md:mx-12 xl:mx-44 mx-4'>
     ...
     grid-cols-4 lg:grid-cols-5 xl:space-x-24'>
      <li onClick={() => setItem(PopularItem)} className='hover:bg-white hover:text-black font-bold
      max-w-[50px] text-center rounded-lg p-2'>All</li>
      <li onClick={() => filterItem('$24')} className='popular '><FaHamburger 
      className='pop-i'/><span>Burger</span></li>
      <li onClick={() => filterItem('$115')} className='popular'><IoMdPizza className='pop-i'/><span>Pizza</span></li>
      <li onClick={() => filterItem('$40')} className='popular'><GiSlicedBread className='pop-i'/>
      <span>Bread</span></li>
      </ul>
      </div>
