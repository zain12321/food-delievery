  ...
  return (
    <div className="grid pt-32 lg:pt-24 grid-cols-1 mx-4 md:mx-12 lg:mx-24 lg:grid-cols-2 items-center">
      <div className="space-y-3">
        <p className="text-[20px] font-bold text-[#212245]">
          Easy way to make an order
        </p>
        <h1 className="hun">
          HUNGRY?
          <span className="hun hun-r">
            Just wait
            <br />
            food at{" "}
          </span>
        ...
        <p className="text-[#777777] text-[16px] py-2">
          {" "}
          ipsum dolor sit amet, consectetur adipisicing elit. Qui magni delectus
   ...
   justify-center px-4 bg-[#DF2020] text-white font-bold rounded-sm"
          >
    ...
    />
          ...
          <p className="flex items-center space-x-3">
            <MdOutlineSystemSecurityUpdateGood
              className="p-2
text-[#fff] rounded-full bg-[#DF2020] h-8 w-8"
            />
            <span className="text-[#212245] font-bold text-[15px] dark:text-[#777777]">
              100% secure checkout
            </span>
          </p>
        </div>
