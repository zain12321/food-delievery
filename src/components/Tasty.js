...
function Tasty() {
  return (
    <div className="grid grid-cols-1 items-center md:grid-cols-2 mx-6 xl:mx-14">
      ...
      <div className="">
        <h1 className="pop text-[24px] text-[#777777] font-bold">
          Why Tasty<span className="text-[#fd2020]"> Treat?</span>
        </h1>
        <p className="text-[#777777] max-w-[600px] py-3  text-[18px]">
        ...
        {tasty.map((item) => {
          ...
          return (
            <div className="py-3 space-y-5">
              <p
                className="flex items-center py-2 space-x-2 text-[#212529] 
                font-bold dark:text-[#777777]"
              >
                <BsCheckCircle className="text-[#fd2020]" />
                <span>{title}</span>
              </p>
