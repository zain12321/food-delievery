...
<p className='text-[#777777] text-[19px]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio quasi
     qui minus quos sit perspiciatis inventore quis provident placeat fugiat!</p>
            </div>
        <SlidersTest/>
        </div>
        <div>
       <img src='https://food-delivery-ecommerce-app.netlify.app/static/media/network.7deb539d.png' alt='' />
        </div>
    </div>
  )
}
